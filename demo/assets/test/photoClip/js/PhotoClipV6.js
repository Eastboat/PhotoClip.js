                    ...
                    function () {
                        ...
                        _createClass(PhotoClip, [{
                            ...
                            value: function _fileOnChangeHandle(e) {
                                ...
                                //图片大小限制在2-5M之间
                                if (files.length) {
                                    if (e.target.id != "file_head") {
                                        if (files[0].size < 409600) {
                                            $("#file").val("");

                                            /*  alert("图片大小须在400KB-10M之间哦,低于800KB可能影响实际印刷效果、还请注意。");*/

                                            //FanfanPoup_new.toast({
                                            //    content: "图片大小须在400KB-10M之间哦,低于800KB可能影响实际印刷效果、还请注意",
                                            //    duration: 2000,
                                            //});

                                            FanfanPoup_new.confirm({
                                                title: '提示信息',
                                                content: '图片大小须在400KB-10M之间哦,低于800KB可能影响实际印刷效果、还请注意',
                                                zIndex:9999999999,
                                                callback_s: function () { },
